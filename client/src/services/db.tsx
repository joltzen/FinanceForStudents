...
export const getTransactions = async (userId: any, month: any, year: any): Promise<any[]> => {
...
export const getTransactionsAnnual = async (userId: any, year: any): Promise<any[]> => {
...
export const getAllTransactions = async (userId: any): Promise<any[]> => {
...
export const getCategories = async (userId: any): Promise<any[]> => {
...
export const getSettings = async (userId: any, month: any, year: any): Promise<any[]> => {
  const q = query(
...
export const getSettingsAnnual = async (userId: any, year: any): Promise<any[]> => {
  const q = query(
    collection(db, "users", userId, "settings"),
    where("year", "==", Number(year)),
  );
...
export const getAllSettings = async (userId: any): Promise<any[]> => {
...
export const getSavingGoals = async (userId: any): Promise<any[]> => {
...
export const getFavorites = async (userId: any): Promise<any[]> => {
