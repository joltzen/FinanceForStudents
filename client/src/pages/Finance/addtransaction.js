...
function AddTransaction({
  ...
  const fieldSx = {
    ...
    "& .MuiInputLabel-root": {
      color: isDark ? "rgba(224,227,233,0.5)" : "rgba(44,47,54,0.5)",
    },
      ...
      >
        ...
        <FormControl fullWidth>
          <Select
            ...
            sx={{
              borderRadius: 2,
              color: theme.palette.text.main,
              backgroundColor: currentCat
                ? `${currentCat.color}22`
                : "transparent",
              "& .MuiOutlinedInput-notchedOutline": {
                borderColor: currentCat
                  ? `${currentCat.color}55`
                  : isDark
        ...
        {sumForSelectedCategory !== 0 && (
          ...
          >
            ...
            >
              Restbudget Kategorie
            </Typography>
            <Typography
              variant="body2"
              sx={{
                fontWeight: 700,
                color: sumForSelectedCategory > 0 ? "#66bb6a" : "#ef5350",
              }}
            >
