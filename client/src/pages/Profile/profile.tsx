        ...
        >
          ...
          >
            ...
            <Box>
              ...
              <Typography
                variant="body2"
                sx={{ color: theme.palette.text.main, opacity: 0.45, mt: 0.25 }}
              >
                @{user?.username}
              </Typography>
              <Typography
                variant="caption"
                sx={{ color: "#c6aa60", opacity: 0.8 }}
              >
                {user?.email}
              </Typography>
            </Box>
          ...
          <CardContent sx={{ p: 3 }}>
            ...
            >
              <Box>
                <Typography
                  variant="body2"
                  sx={{ color: theme.palette.text.main, fontWeight: 600 }}
                >
                  Konto löschen
                </Typography>
                <Typography
                ...
                >
                  Alle Daten werden dauerhaft gelöscht. Nicht rückgängig
                  machbar.
                </Typography>
              </Box>
              <Button
      ...
      >
        ...
        <DialogContent>
          ...
          >
            ...
            Daten, Transaktionen und Einstellungen werden dauerhaft gelöscht.
          </DialogContentText>
        </DialogContent>
